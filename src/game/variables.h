...
MACRO_CONFIG_INT(ClShowSilentMessages, cl_show_silent_messages, 1, 0, 2, CFGFLAG_CLIENT|CFGFLAG_SAVE, "0=vanilla/off 1=show in non race 2=show in all gametypes")
...
MACRO_CONFIG_INT(DummyUseCustomColorBody, dummy_use_custom_color_body, 1, 0, 1, CFGFLAG_CLIENT|CFGFLAG_SAVE, "Toggles usage of custom colors for body")
MACRO_CONFIG_INT(DummyUseCustomColorMarking, dummy_use_custom_color_marking, 1, 0, 1, CFGFLAG_CLIENT|CFGFLAG_SAVE, "Toggles usage of custom colors for marking")
MACRO_CONFIG_INT(DummyUseCustomColorDecoration, dummy_use_custom_color_decoration, 1, 0, 1, CFGFLAG_CLIENT|CFGFLAG_SAVE, "Toggles usage of custom colors for decoration")
MACRO_CONFIG_INT(DummyUseCustomColorHands, dummy_use_custom_color_hands, 1, 0, 1, CFGFLAG_CLIENT|CFGFLAG_SAVE, "Toggles usage of custom colors for hands")
MACRO_CONFIG_INT(DummyUseCustomColorFeet, dummy_use_custom_color_feet, 1, 0, 1, CFGFLAG_CLIENT|CFGFLAG_SAVE, "Toggles usage of custom colors for feet")
MACRO_CONFIG_INT(DummyUseCustomColorEyes, dummy_use_custom_color_eyes, 1, 0, 1, CFGFLAG_CLIENT|CFGFLAG_SAVE, "Toggles usage of custom colors for eyes")
