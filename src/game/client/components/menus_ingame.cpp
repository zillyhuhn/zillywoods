...
void CMenus::RenderGame(CUIRect MainView)
{
	...
	// buttons
	{
		...
		// Record button
		ButtonRow.VSplitRight(10.0f, &ButtonRow, 0);
		ButtonRow.VSplitRight(90.0f, &ButtonRow, &Button);
	...
	ButtonRow.VSplitLeft(10.0f, 0, &ButtonRow);
	ButtonRow.VSplitLeft(120.0f, &Button, &ButtonRow);
